...
import './index.css';
import ProductDetails from '../ProductDetails/product_details';
            ...
            <div className="card p-2" style={{ width: '18rem' }}>
              <a href="/product_details">
                ...
                <svg
                  ...
                  id="heart-icon"
                  style={{ position: 'absolute', top: 2, right: 4, margin: '8px' }}
                >
              ...
              <div className="card-body row">
                <div className="col">
                  ...
                  <p className="card-text">This is the favorite cake of many people</p>
                </div>
